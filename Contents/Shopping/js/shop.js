...
Shop_en[3] = new Array ( "San Antonio Express-News","Catch the latest news, travel essentials and snacks from San Antonio Express- News. Offering an assortment of newsstand offerings, travelers will also enjoy exclusive postcards from San Antonio, along with exclusively designed apparel, fashion accessories, gifts and souvenirs.", "images/4.png" , "images/offers/404.png" );
Shop_en[4] = new Array ( "Simply Books","Fewer things compare to a perfectly selected book and cup of coffee. Both can be found at Simply Books, which features Starbucks and the best-sellers. The only airport-based bookstore in the continental U.S. that can make that claim.", "images/5.png" , "images/offers/404.png" );
Shop_en[5] = new Array ( "Stars of San Antonio","Stock up for the one who’s deep in your heart. Texas-themed jewelry, shirts and sauces abound at this shop that offers 10% for every $100 purchase.", "images/6.png", "images/offers/Stars of San Antonio/Stars of San Antonio-1.png" );
Shop_en[6] = new Array ( "UETA Duty Free","UETA Duty Free offers top quality spirits and tobaccos for international travelers, and brand name fragrances, cosmetics and luxury gifts for all. High-end merchandise at dramatically low prices will impress the most discriminating shopper…and a discount aisle offers another 25% off.", "images/8.png" , "images/offers/404.png" );
...
Shop_sp[3] = new Array ( "San Antonio Express-News","Vea las últimas noticias, artículos esenciales de viaje y refrigerios de San Antonio Express-News. Ofreciendo una variedad de ofertas de quiosco, los viajeros también podrán disfrutar de postales exclusivas de San Antonio, junto con vestimenta de diseño exclusivo, accesorios de moda, regalos y recuerdos.", "images/4.png" , "images/offers/404.png" );
Shop_sp[4] = new Array ( "Simply Books","Menos cosas se comparan con un libro y una taza de café perfectamente seleccionados. Ambos se pueden encontrar en Simply Books, que presenta Starbucks y los best-sellers. La única librería basada en el aeropuerto en los EE. UU. Continentales que puede hacer esa afirmación.", "images/5.png" , "images/offers/404.png" );
Shop_sp[5] = new Array ( "Stars of San Antonio","Abastécete de quien está en lo más profundo de tu corazón. En esta tienda, abundan las joyas, camisetas y salsas con temas de Texas, que ofrecen un 10% por cada compra de $ 100..", "images/6.png", "images/offers/Stars of San Antonio/Stars of San Antonio-1.png" );
Shop_sp[6] = new Array ( "UETA Duty Free","UETA Duty Free ofrece licores y tabacos de alta calidad para viajeros internacionales, y fragancias de marca, cosméticos y regalos de lujo para todos. La mercancía de alta gama a precios dramáticamente bajos impresionará al comprador más exigente ... y un pasillo de descuento ofrece otro 25% de descuento.", "images/8.png" , "images/offers/404.png" );
